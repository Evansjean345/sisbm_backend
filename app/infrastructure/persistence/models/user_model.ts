...
export default class UserModel extends BaseModel {
  ...
  /**
   * Révoque TOUTES les sessions du compte (changement de mot de passe,
   * suspension, suppression). Porté par le modèle pour que la présentation
   * n'ait jamais à toucher la base directement (`npm run arch`).
   */
